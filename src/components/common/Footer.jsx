    ...
    theprateekpixelss
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <FooterLink to="/digital-invite-service">
        ...
        <div className="border-t border-zinc-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>
            © {new Date().getFullYear()} The Prateek Pixelss. All rights
            reserved.
          </p>
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              href=" https://www.instagram.com/pratikmehakare?utm_source=qr&igsh=MXRoc3BuYW44bjRlZw=="
              target="_blank"
              rel="noopener noreferrer"
              className="text-purple-400 font-medium flex items-center gap-1 hover:text-purple-300 transition-colors hover:underline"
            >
              Pratik Mehakare
            </a>
          </div>
